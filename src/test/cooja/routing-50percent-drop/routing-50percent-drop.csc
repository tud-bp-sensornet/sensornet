...
<simconf>
  ...
  <simulation>
    <title>Routing-test-50percent-drop</title>
    <randomseed>548752</randomseed>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONFIG_DIR]/sensornet.c</source>
      <commands EXPORT="discard">make sensornet.sky TARGET=sky</commands>
      <firmware EXPORT="copy">[CONFIG_DIR]/sensornet.sky</firmware>
  ...
  <plugin>
    ...
    <plugin_config>
      <scriptfile>[CONFIG_DIR]/routing.js</scriptfile>
      <active>true</active>
    </plugin_config>
    <width>600</width>
    <z>1</z>
